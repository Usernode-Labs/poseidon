...
fn bench_simple_hash_stream(c: &mut Criterion) {
    ...
    for &n in &[128usize, 1024, 4096, 16384] {
        ...
        group.bench_with_input(BenchmarkId::new("pallas_update_digest", n), &inputs, |b, inputs| {
            b.iter_batched(
...
criterion_group!(benches, bench_simple_hash_stream, bench_simple_hash_reuse_reset);
